...
public class JoystickBox extends IJoystick {
	...
	public JoystickBox(int port) {
        ...
        add("ClimbLevel 2", new ValueUsage(Keys.CLIMB_LEVEL_2, false));
        add("ClimbLevel 1", new ValueUsage(Keys.CLIMB_LEVEL_1, false));
        add("HatchOut", new ValueUsage(Keys.COLLECTOR_HATCH_OUT, false));
        add("HatchLevel1", new ValueUsage(Keys.HATCH_LEVEL_1, false));
        add("HatchLevel2", new ValueUsage(Keys.HATCH_LEVEL_2, false));
        add("HatchLevel3", new ValueUsage(Keys.HATCH_LEVEL_3, false));
